...
export const InterventionNotice: React.FC<Props> = ({
  level,
  escalateSecs = 0,
}) => {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center gap-2 rounded-2xl px-6 py-3 text-lg font-semibold text-white shadow-2xl ${
          level === 1
            ? "bg-amber-600/80"
            : level === 2
              ? "bg-orange-600/85"
